...
5. 由於 Pester 測試結果回傳的是 PowerShell [PSCustomObject](http://learn.microsoft.com/powershell/scripting/learn/deep-dives/everything-about-pscustomobject) 型態的 hash table，所以透過 `Properties` 屬性來取得各個測試結果的屬性值。
