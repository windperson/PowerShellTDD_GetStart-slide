...
* 使用 [`PowerShell.Standard.Library` Nuget 套件](http://www.nuget.org/packages/PowerShellStandard.Library/)的 binary cmdlet 可在 Windows PowerShell 5.1+ & PowerShell 7+ 環境中執行。
* 使用 [`System.Management.Automation` Nuget 套件](http://www.nuget.org/packages/System.Management.Automation/)的 binary cmdlet 僅能在 PowerShell Core/7+ 環境中執行。
