...
![](./pics/shell_knights.jpg){fig-align="center"}

:::
::::

# {visibility="uncounted" background-image="./pics/special_thanks.png" background-position="center" background-repeat="no-repeat" background-size="100%"}
